"""Suite del nucleo de parseo de package.json (H4-T14, design §3.3, R2.3-R2.6).

Ejercita el nucleo `_parse_package_json_content`/`_parse_dep_block`/`_is_exact_registry_pin`
(manifiesto npm NO confiable), cubriendo la red de seguridad de la entrada que el adapter y
stdin reutilizan (H4-T16/H4-T19). Metodologia: tratar todo el JSON como hostil.
